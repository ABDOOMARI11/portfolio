...
export function EducationSection() {
  ...
  return (
    <section id="education" className="py-24 bg-gradient-to-br from-secondary/30 via-secondary/50 to-secondary/70 dark:from-accent/20 dark:via-accent/30 dark:to-accent/40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="text-center mb-16">
            <h2 className="section-title bg-gradient-to-r from-morocco-blue to-morocco-gold bg-clip-text text-transparent">
              Parcours Académique
            </h2>
            <motion.div
              initial={{ width: 0 }}
